    ...
    <div class="card card-success card-outline mb-4">
        ...
        <div class="card-body mt-3 mb-3">
            ...
            <button type="button" class="btn btn-outline-success rounded-0 float-end mb-2" data-bs-toggle="modal"
                onclick="openModal('create')"><i class="fa-solid fa-tags m-1 ms-0"></i>
                    ...
                    <form class="needs-validation" id="editCreateForm" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <!--begin::Col-->
                                <div class="col-md-12">
                                    <label for="name_ar" class="form-label">{{ __('dashboard.layout.name_ar') }}</label>
                                    <input type="text" class="form-control" id="name_ar" minlength="2" required>
                                    <div class="invalid-feedback">{{ __('dashboard.validation.inter_name') }}</div>
                                    <span class="invalid-feedback-req" id="name.ar-error"></span>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-md-12">
                                    <label for="name_en" class="form-label">{{ __('dashboard.layout.name_en') }}</label>
                                    <input type="text" class="form-control" id="name_en" minlength="2" required>
                                    <div class="invalid-feedback">{{ __('dashboard.validation.inter_name') }}</div>
                                    <span class="invalid-feedback-req" id="name.en-error"></span>
                                </div>
                                <!--end::Col-->
                            </div> <!--end::Body-->
                        </div>
    ...
    <script>
        function submitForm(event, type = null) {
            ...
            locales.forEach(locale => {
                ...
                if (nameInput) {
                    data.append(`name[${locale}]`, nameInput.value);
                }
            });
