            ...
            <div class="row"> <!--begin::Col-->
                <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 1-->
                    {{-- <div class="small-box text-bg-primary">
                        <div class="inner">
                            <h3>{{$clients}}</h3>
                            <p>{{ __('dashboard.home.clients') }}</p>
                         </div>
                         <div class="small-box-icon">
                            <i class="bi bi-person-vcard-fill" fill="currentColor"></i>
                         </div>
                ...
                {{-- <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 2-->
                    <div class="small-box text-bg-success">
                        <div class="inner">
                            <h3>{{$users}}</h3>
                            <p>{{ __('dashboard.home.users') }}</p>
                        </div>
                        <div class="small-box-icon">
                            <i class="fa-solid fa-users-gear" fill="currentColor"></i>
                         </div>
                ...
                {{-- <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 3-->
                    <div class="small-box text-bg-warning">
                        <div class="inner">
                            <h3>{{$suppliers}}</h3>
                            <p>{{ __('dashboard.home.suppliers') }}</p>
                        </div>
                        <div class="small-box-icon">
                            <i class="fa-solid fa-truck-medical" fill="currentColor"></i>
                         </div>
                ...
                {{-- <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 4-->
                    <div class="small-box text-bg-danger">
                        <div class="inner">
                            <h3>{{$products}}</h3>
                            <p> {{ __('dashboard.home.products') }}</p>
                        </div>
                        <div class="small-box-icon">
                            <i class="fa-solid fa-dolly" fill="currentColor"></i>
                         </div>
                 ...
                 <div class="col-lg-7 connectedSortable">
                    ...
                    <div class="card direct-chat direct-chat-primary mb-4">
                        <div class="card-header">
                            ...
                            <div class="card-tools"> <span title="3 New Messages"
                            ...
                            <div class="direct-chat-messages"> <!-- Message. Default to the start -->
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-infos clearfix"> <span
                                            ...
                                            23 Jan 2:00 pm
                                        </span> </div> <!-- /.direct-chat-infos --> <img
                                        class="direct-chat-img" src="../../dist/assets/img/user1-128x128.jpg"
                                ...
                                <div class="direct-chat-msg end">
                                    <div class="direct-chat-infos clearfix"> <span
                                        ...
                                        class="direct-chat-img" src="../../dist/assets/img/user3-128x128.jpg"
                                        alt="message user image"> <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
